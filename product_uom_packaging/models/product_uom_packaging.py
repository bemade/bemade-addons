...
class ProductUomPackaging(models.Model):
    ...
    partner_id = fields.Many2one(
        ...
        index=True,
        ondelete="restrict",
        help="Optional: restrict this packaging to a specific vendor for "
        "purchase. Leave blank for sales/generic packaging.",
    )
    ...
    def _check_unique_packaging(self):
        """Ensure only one packaging per template/UoM/qty/package_type/company/partner."""
        for record in self:
