...
from odoo.addons.calendar_ics_videocall.models.calendar_event import (
    CalendarEvent as VideocallCalendarEvent,
)
...
class TestIcsVideocall(TransactionCase):
    ...
    def test_no_videocall_leaves_ics_untouched(self):
        ...
        DESCRIPTION. Asserted against this module's own super(), not against
        core: another installed module may legitimately enrich the ICS too
        (e.g. calendar_ics_method_request adds METHOD:REQUEST), and that must
        ...
        core = super(VideocallCalendarEvent, event)._get_ics_file()[event.id]
