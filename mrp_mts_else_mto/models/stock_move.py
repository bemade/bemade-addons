...
class StockMove(models.Model):
    ...
    def _prepare_procurement_values(self):
        ...
        However, with mts_else_mto rules, _adjust_procure_method() sets
        move.procure_method = 'make_to_stock', but _action_confirm() still
        creates procurement because it checks rule.procure_method. This means
        move_dest_ids is NOT included and child MOs are created without parent link.
