...
The ETL Framework is a declarative, self-optimizing system for migrating data from external sources into Odoo. It provides a clean separation between Extract, Transform, and Load phases while automatically optimizing execution strategy based on data volume.

Originally developed for SAP Business One migrations, this framework is generic and can be used for any data migration into Odoo.
